...
class Mark
	...
	def turn_to_new_heading_radar new_heading
		...
		adjust_heading = calculate_degrees_to_new_heading( new_heading )
	...
	def calculate_degrees_to_new_heading new_heading
		
#		degrees_to_new_heading = 360 - (heading - new_heading)
		degrees_to_new_heading = 360 - (new_heading - heading)
		puts "calculate_degrees_to_new_heading = \n"         +
		     "        current heading = " + heading.to_s     + "\n" +
		     "            new heading = " + new_heading.to_s + "\n" +
#		     " degrees to new heading = " + ((heading - new_heading)*-1).to_s
